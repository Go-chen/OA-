		...
		function viewPermission(username){
			...
			$.ajax({
				...
				success:function(sysRole){
					var role = "<tr><td>";
					role += sysRole.name+"</td><br/><td>";
					   for (var i = 0; i < sysRole.permissionList.length; i++){
						role +=	sysRole.permissionList[i].name + "【" + sysRole.permissionList[i].type + "】<br/>";
					 } 
					   role += "</td></tr>";
						$("#roleListBody").html(role);
				}
			});
		}
